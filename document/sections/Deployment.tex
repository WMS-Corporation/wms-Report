...
\section{Deployment}
Il processo di deployment del nostro progetto è stato completamente automatizzato attraverso l'utilizzo di GitHub\cite{github} Actions, permettendo una Continuous Integration (CI) e Continuous Deployment (CD) efficiente. Questo approccio riduce significativamente il tempo e gli sforzi necessari per il rilascio di nuove versioni dell'applicativo.
